library(dplyr)
library(ggplot2)
long.random.forest.any <- read.table("~/LOBICO/Output/long.random.forest.any.ACCURACY.txt", header = T)
long.random.forest.down <- read.table("~/LOBICO/Output/long.random.forest.down.ACCURACY.txt", header = T)
short.random.forest.any <- read.table("~/LOBICO/Output/short.random.forest.any.ACCURACY.txt", header = T)
short.random.forest.up <- read.table("~/LOBICO/Output/short.random.forest.up.ACCURACY.txt", header = T)
